...
const PlacesFormPage = () => {
  ...
  const [title,setTitle]=useState('');
    ...
    useEffect(()=>{
      ...
      axios.get('https://airnbback.onrender.com/places/'+id).then(res=>{
        const {data} = res;
        setTitle(data.title);
    ...
    async function savePlace(ev) {
      ...
      if (id) {
        // update
        await axios.put('https://airnbback.onrender.com/places', {
          id, ...placeData
        });
        setRedirect(true);
      } else {
        // new place
        await axios.post('https://airnbback.onrender.com/places', placeData);
        setRedirect(true);
      }
    ...
    //     checkin, checkout, maxGuests, price,
    //   };
    //   // await axios.post('https://airnbback.onrender.com/places',{
