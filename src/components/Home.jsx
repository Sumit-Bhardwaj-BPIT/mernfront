...
export default function Home() {
  const [places,setPlaces] = useState([]);
  useEffect(() => {
    axios.get('https://airnbback.onrender.com/home').then(response => {
        ...
        <Link to={'/place/'+place._id}>
          <div className="bg-gray-500  mb-2 rounded-2xl ">
            {place.addedPhotos?.[0] && (
              ...
              <img className="rounded-2xl object-cover aspect-square" src={'https://airnbback.onrender.com/uploads/'+place.addedPhotos?.[0]} />
            )}
          </div>
